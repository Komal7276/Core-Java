...
class StudentResult
{
	...
	public static void main(String[] args) {
		...
		{	
			...
			int sub1 = sc.nextInt();
			int sub2 = sc.nextInt();
		 	percentage = sr.calculate(sub1, sub2);
		}
		...
		else if(n == 3)
		{
			...
			int sub2 = sc.nextInt();
		 	int sub3 = sc.nextInt();
		 	percentage = sr.calculate(sub1, sub2,sub3);
		}
		...
		else if( n == 4)
		{
			...
			int sub2 = sc.nextInt();
		 	int sub3 = sc.nextInt();
		 	int sub4 = sc.nextInt();
		 	percentage = sr.calculate(sub1, sub2, sub3, sub4);
		}
		...
		else if( n == 5)
		{
			...
			int sub2 = sc.nextInt();
		 	...
		 	int sub4 = sc.nextInt();
		 	int sub5 = sc.nextInt();
		 	percentage = sr.calculate(sub1, sub2, sub3, sub4, sub5);
		}
		...
		else if( n == 6)
		{
			...
			int sub2 = sc.nextInt();
		 	...
		 	int sub5 = sc.nextInt();
		 	int sub6 = sc.nextInt();
		 	percentage = sr.calculate(sub1, sub2, sub3, sub4, sub5, sub6);
		}
		...
		System.out.println("Grade: "+ sr.grade(percentage));
